...
public class AdminController {
	...
	public ResponseEntity< List<CommentDTO>> getCommentByTaskId(@PathVariable Long taskId) {
	 ...
	 @PreAuthorize("hasRole('ADMIN')")
	    @GetMapping("/admin/charts/priority")
	    public ResponseEntity<Map<String, Long>> getTaskCountByPriorityForAdmin() {
	        Map<String, Long> taskCountByPriority = adminService.getTaskCountByPriorityForAdmin();
	        return ResponseEntity.ok(taskCountByPriority);
	    }

	    @PreAuthorize("hasRole('ADMIN')")
	    @GetMapping("/admin/charts/status")
	    public ResponseEntity<Map<String, Long>> getTaskCountByStatusForAdmin() {
	        Map<String, Long> taskCountByStatus = adminService.getTaskCountByStatusForAdmin();
